...
urlpatterns = [
    ...
    path(
        "provider/node/<yagna_id>/earnings/<int:hours>",
    ...
    path(
        "provider/node/<yagna_id>/total/computed/seconds",
        views.provider_seconds_computed_total,
    ),
    path("provider/wallet/<wallet>", views.node_wallet),
    path("network/provider/average/earnings", views.providers_average_earnings),
    ...
    path(
        "network/market/agreement/termination/reasons",
        views.market_agreement_termination_reason,
    ),
    path("network/market/invoice/paid/1h", views.paid_invoices_1h),
    path(
